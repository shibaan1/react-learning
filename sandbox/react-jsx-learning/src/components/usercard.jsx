...
// now to make different comnponents what we can do is create that component seprately and then use it anyehere we want. creating components means we create an arrow function for the element and then use that function anywhere by importing it. the whole functionality of the element should be in a single div. also when we give class name in react we use 'classname'. The name of the component must start from a capital letter and the varibale to render ot must be in the {} otherwise it will be treated as literal
